function initialize() {
    ...
    var n = {},
        i = (new google.maps.Marker({
            position: mapAddress,
            map: map
        }), new google.maps.StyledMapType(e, n));
...
if (function(e, t) {
        ...
        function u(e, t, n, i) {
            if (ae.acceptData(e)) {
                var a, r, o = ae.expando,
                    ...
                    l = s ? ae.cache : e,
                    d = s ? e[o] : e[o] && o;
                if (d && l[d] && (i || l[d].data) || void 0 !== n || "string" != typeof t) return d || (d = s ? e[o] = U.pop() || ae.guid++ : o), l[d] || (l[d] = s ? {} : {
                    toJSON: ae.noop
        ...
        function N(e, t) {
            if (t in e) return t;
            for (var n = t.charAt(0).toUpperCase() + t.slice(1), i = t, a = ct.length; a--;)
                if (t = ct[a] + n, t in e) return t;
            return i
        }
        ...
        function z(e, t, n) {
            for (var i, a = (wt[t] || []).concat(wt["*"]), r = 0, o = a.length; o > r; r++)
                if (i = a[r].call(n, t, e)) return i
        }

        function H(e, t, n) {
            var i, a, r, o, s, l, d, u, p = this,
                c = {},
                f = e.style,
                h = e.nodeType && De(e),
                m = ae._data(e, "fxshow");
            ...
            if (ae.isEmptyObject(c)) "inline" === ("none" === d ? E(e.nodeName) : d) && (f.display = d);
            else {
        ...
        function O(e, t, n) {
            var i, a, r = 0,
                ...
                u = d.props;
            for (B(u, d.opts.specialEasing); o > r; r++)
                if (i = yt[r].call(d, e, u, d.opts)) return i;
            ...
            for (r = u.shift(); r;)
                ...
                if (o !== !0)
                    if (o && e["throws"]) t = o(t);
                        ...
                        return {
                            state: "parsererror",
                            error: o ? p : "No conversion from " + l + " to " + r
                        }
                    }
            }
            return {
        ...
        ae.fn = ae.prototype = {
            ...
            for ("boolean" == typeof o && (d = o, o = arguments[s] || {}, s++), "object" == typeof o || ae.isFunction(o) || (o = {}), s === l && (o = this, s--); l > s; s++)
                if (null != (a = arguments[s]))
                    for (i in a) e = o[i], n = a[i], o !== n && (d && n && (ae.isPlainObject(n) || (t = ae.isArray(n))) ? (t ? (t = !1, r = e && ae.isArray(e) ? e : []) : r = e && ae.isPlainObject(e) ? e : {}, o[i] = ae.extend(d, r, n)) : void 0 !== n && (o[i] = n));
            return o
        }, ae.extend({
        ...
        var de = function(e) {
            ...
            function v(e, t, n, a, r, o) {
                return a && !a[j] && (a = v(a)), r && !r[j] && (r = v(r, o)), i(function(i, o, s, l) {
                    var d, u, p, c = [],
                        ...
                        y = !e || !i && t ? v : g(v, c, e, s, l),
                        w = n ? r || (i ? e : h || a) ? [] : o : y;
                    if (n && n(y, w, s, l), a)
                        for (d = g(w, f), a(d, [], s, l), u = d.length; u--;)(p = d[u]) && (w[f[u]] = !(y[f[u]] = p));
                    if (i) {
                        if (r || e) {
                            if (r) {
                    ...
                    if (n = T.relative[e[s].type]) u = [f(h(u), n)];
                        ...
                        if (n = T.filter[e[s].type].apply(null, e[s].matches), n[j]) {
                            ...
                            return v(s > 1 && h(u), s > 1 && c(e.slice(0, s - 1).concat({
                                value: " " === e[s - 2].type ? "*" : ""
                            })).replace(le, "$1"), n, i > s && y(e.slice(s, i)), a > i && y(e = e.slice(i)), a > i && c(e))
                        }
                        u.push(n)
                    }
                return h(u)
            ...
            var b, x, T, C, S, E, k, N, D, M, A, I, L, $, P, z, H, B, O, j = "sizzle" + 1 * new Date,
                R = e.document,
                F = 0,
                W = 0,
                _ = n(),
            ...
            x = t.support = {}, S = t.isXML = function(e) {
                ...
                var n = T.attrHandle[t.toLowerCase()],
                    i = n && U.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !P) : void 0;
                ...
                filter: {
                    ...
                    CHILD: function(e, t, n, i, a) {
                        ...
                        return 1 === i && 0 === a ? function(e) {
                            ...
                            var d, u, p, c, f, h, m = r !== o ? "nextSibling" : "previousSibling",
                                g = t.parentNode,
                            ...
                            if (g) {
                                ...
                                if (h = [o ? g.firstChild : g.lastChild], o && y) {
                                    for (u = g[j] || (g[j] = {}), d = u[e] || [], f = d[0] === F && d[1], c = d[0] === F && d[2], p = f && g.childNodes[f]; p = ++f && p && p[m] || (c = f = 0) || h.pop();)
                                        if (1 === p.nodeType && ++c && p === t) {
                                            u[e] = [F, f, c];
                                            break
                                        }
                                } else if (y && (d = (t[j] || (t[j] = {}))[e]) && d[0] === F) c = d[1];
                                else
                                    for (;
                                        (p = ++f && p && p[m] || (c = f = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++c || (y && ((p[j] || (p[j] = {}))[e] = [F, c]), p !== t)););
            ...
            return p.prototype = T.filters = T.pseudos, T.setFilters = new p, E = t.tokenize = function(e, n) {
                ...
                if (n = n || [], 1 === p.length) {
                    ...
                    for (a = he.needsContext.test(e) ? 0 : r.length; a-- && (o = r[a], !T.relative[s = o.type]);)
                        if ((l = T.find[s]) && (i = l(o.matches[0].replace(xe, Te), we.test(r[0].type) && u(t.parentNode) || t))) {
        ...
        var fe, he = e.document,
            ...
            ge = ae.fn.init = function(e, t) {
                ...
                if ("string" == typeof e) {
                    ...
                    if (n[1]) {
                        if (t = t instanceof ae ? t[0] : t, ae.merge(this, ae.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : he, !0)), pe.test(n[1]) && ae.isPlainObject(t))
        ...
        ae.extend({
            ...
            closest: function(e, t) {
                for (var n, i = 0, a = this.length, r = [], o = ue.test(e) || "string" != typeof e ? ae(e, t || this.context) : 0; a > i; i++)
        ...
        ae.Callbacks = function(e) {
            ...
            when: function(e) {
                ...
                if (o > 1)
                    for (t = new Array(o), n = new Array(o), i = new Array(o); o > a; a++) r[a] && ae.isFunction(r[a].promise) ? r[a].promise().done(d(a, i, r)).fail(l.reject).progress(d(a, n, t)) : --s;
            ...
            remove: function(e, t, n, i, a) {
                ...
                if (g && (u = g.events)) {
                    for (t = (t || "").match(we) || [""], d = t.length; d--;)
                        if (s = ze.exec(t[d]) || [], f = m = s[1], h = (s[2] || "").split(".").sort(), f) {
                            ...
                            for (f in u) ae.event.remove(e, f + t[d], n, i, !0);
                    ae.isEmptyObject(u) && (delete g.handle, ae._removeData(e, "events"))
                }
            },
            trigger: function(t, n, i, a) {
                var r, o, s, l, d, u, p, c = [i || he],
                ...
                if (s = u = i = i || he, 3 !== i.nodeType && 8 !== i.nodeType && !Pe.test(f + ae.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), o = f.indexOf(":") < 0 && "on" + f, t = t[ae.expando] ? t : new ae.Event(f, "object" == typeof t && t), t.isTrigger = a ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : ae.makeArray(n, [t]), d = ae.event.special[f] || {}, a || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                    ...
                    for (p = 0;
                        (s = c[p++]) && !t.isPropagationStopped();) t.type = p > 1 ? l : d.bindType || f, r = (ae._data(s, "events") || {})[t.type] && ae._data(s, "handle"), r && r.apply(s, n), r = o && s[o], r && r.apply && ae.acceptData(s) && (t.result = r.apply(s, n), t.result === !1 && t.preventDefault());
        ...
        Ye.optgroup = Ye.option, Ye.tbody = Ye.tfoot = Ye.colgroup = Ye.caption = Ye.thead, Ye.th = Ye.td, ae.extend({
            clone: function(e, t, n) {
                ...
                if (ne.html5Clone || ae.isXMLDoc(e) || !Oe.test("<" + e.nodeName + ">") ? r = e.cloneNode(!0) : (Ke.innerHTML = e.outerHTML, Ke.removeChild(r = Ke.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ae.isXMLDoc(e)))
                    for (i = g(r), s = g(e), o = 0; null != (a = s[o]); ++o) i[o] && C(a, i[o]);
                if (t)
                    if (n)
                        for (s = s || g(e), i = i || g(r), o = 0; null != (a = s[o]); o++) T(a, i[o]);
                    else T(e, r);
                return i = g(r, "script"), i.length > 0 && x(i, !l && g(e, "script")), i = s = a = null, r
            },
            buildFragment: function(e, t, n, i) {
                for (var a, r, o, s, l, d, u, p = e.length, c = m(t), f = [], h = 0; p > h; h++)
                    if (r = e[h], r || 0 === r)
                    ...
                    if (!ne.leadingWhitespace && je.test(r) && f.push(t.createTextNode(je.exec(r)[0])), !ne.tbody)
                        for (r = "table" !== l || We.test(r) ? "<table>" !== u[1] || We.test(r) ? 0 : s : s.firstChild, a = r && r.childNodes.length; a--;) ae.nodeName(d = r.childNodes[a], "tbody") && !d.childNodes.length && r.removeChild(d);
                    for (ae.merge(f, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                    s = c.lastChild
                } else f.push(t.createTextNode(r));
                for (s && c.removeChild(s), ne.appendChecked || ae.grep(g(f, "input"), v), h = 0; r = f[h++];)
                    if ((!i || -1 === ae.inArray(r, i)) && (o = ae.contains(r.ownerDocument, r), s = g(c.appendChild(r), "script"), o && x(s), n))
                        for (a = 0; r = s[a++];) Ve.test(r.type || "") && n.push(r);
                return s = null, c
            },
            cleanData: function(e, t) {
                for (var n, i, a, r, o = 0, s = ae.expando, l = ae.cache, d = ne.deleteExpando, u = ae.event.special; null != (n = e[o]); o++)
                    if ((t || ae.acceptData(n)) && (a = n[s], r = a && l[a])) {
                        if (r.events)
                            for (i in r.events) u[i] ? ae.event.remove(n, i) : ae.removeEvent(n, i, r.handle);
            ...
            domManip: function(e, t) {
                ...
                if (d && (s = ae.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                    ...
                    if (a)
                        for (o = r[r.length - 1].ownerDocument, ae.map(r, b), l = 0; a > l; l++) i = r[l], Ve.test(i.type || "") && !ae._data(i, "globalEval") && ae.contains(o, i) && (i.src ? ae._evalUrl && ae._evalUrl(i.src) : ae.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Ue, "")));
                    s = n = null
                }
                return this
            }
        ...
        var xt, Tt, Ct = ae.expr.attrHandle,
        ...
        ae.fn.extend({
            ...
            removeAttr: function(e, t) {
                var n, i, a = 0,
                    r = t && t.match(we);
                if (r && 1 === e.nodeType)
                    for (; n = r[a++];) i = ae.propFix[n] || n, ae.expr.match.bool.test(n) ? kt && Et || !St.test(n) ? e[i] = !1 : e[ae.camelCase("default-" + n)] = e[i] = !1 : ae.attr(e, n, ""), e.removeAttribute(Et ? n : i)
            },
            attrHooks: {
                type: {
                    set: function(e, t) {
        ...
        ae.fn.extend({
            ...
            toggleClass: function(e, t) {
                ...
                return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ae.isFunction(e) ? function(n) {
                    ...
                    if ("string" === n)
                        for (var t, i = 0, a = ae(this), r = e.match(we) || []; t = r[i++];) a.hasClass(t) ? a.removeClass(t) : a.addClass(t);
        ...
        $t = Ft.exec(Pt.toLowerCase()) || [], ae.extend({
            ...
            ajax: function(e, t) {
                ...
                var i, a, r, o, s, l, d, u, p = ae.ajaxSetup({}, t),
                    c = p.context || p,
                    f = p.context && (c.nodeType || c.jquery) ? ae(c) : ae.event,
                    h = ae.Deferred(),
                    ...
                    x = {
                        ...
                        getResponseHeader: function(e) {
                            ...
                            if (2 === w) {
                                if (!u)
                                    for (u = {}; t = Bt.exec(o);) u[t[1].toLowerCase()] = t[2];
                                t = u[e.toLowerCase()]
                            }
                    ...
                    send: function(n, i) {
                        ...
                        r.send(e.hasContent && e.data || null), t = function(n, a) {
                            ...
                            if (t && (a || 4 === r.readyState))
                                if (delete Jt[o], t = void 0, r.onreadystatechange = ae.noop, a) 4 !== r.readyState && r.abort();
                                else {
        ...
        ae.offset = {
            setOffset: function(e, t, n) {
                var i, a, r, o, s, l, d, u = ae.css(e, "position"),
                    p = ae(e),
                    c = {};
        ...
        var t, n = function(e, a) {
            ...
            var m = {};
            for (var g in a)
                if ("object" != typeof a[g] || null === a[g] || a[g].nodeType || a[g] === window || a[g] === document || "undefined" != typeof i && a[g] instanceof i || "undefined" != typeof jQuery && a[g] instanceof jQuery) m[g] = a[g];
                else {
                    m[g] = {};
            ...
            if (b.params = a, b.originalParams = m, b.classNames = [], "undefined" != typeof t && "undefined" != typeof i && (t = i), ("undefined" != typeof t || (t = "undefined" == typeof i ? window.Dom7 || window.Zepto || window.jQuery : i)) && (b.$ = t, b.currentBreakpoint = void 0, b.getActiveBreakpoint = function() {
                        ...
                        for (e = 0; e < b.slides.length; e++) {
                            ...
                            if (b.params.slidesPerColumn > 1) {
                                ...
                                "column" === b.params.slidesPerColumnFill ? (f = Math.floor(e / l), h = e - f * l, (f > u || f === u && h === l - 1) && ++h >= l && (h = 0, f++), c = f + h * o / l, p.css({
                                    ...
                                    "-webkit-order": c,
                                    order: c
                                })) : (h = Math.floor(e / d), f = e - h * d), p.css({
                        ...
                        for (var n = 0; n < b.slides.length; n++) {
                            ...
                            if (b.params.watchSlidesVisibility) {
                                var r = -(t - i.swiperSlideOffset),
                                    ...
                                    s = r >= 0 && r < b.size || o > 0 && o <= b.size || 0 >= r && o >= b.size;
                ...
                var C, S, E, k, N, D, M, A, I, L, $ = "input, select, textarea, button",
                    P = Date.now(),
                    z = [];
                        ...
                        if (e.originalEvent && (e = e.originalEvent), E && b.emit("onTouchEnd", b, e), E = !1, C) {
                            ...
                            if (a = b.params.followFinger ? b.rtl ? b.translate : -b.translate : -D, b.params.freeMode) {
                                ...
                                if (b.params.freeModeMomentum) {
                                    ...
                                    if (p < b.maxTranslate()) b.params.freeModeMomentumBounce ? (p + b.maxTranslate() < -h && (p = b.maxTranslate() - h), c = b.maxTranslate(), f = !0, L = !0) : p = b.maxTranslate();
                                    else if (p > b.minTranslate()) b.params.freeModeMomentumBounce ? (p - b.minTranslate() > h && (p = b.minTranslate() + h), c = b.minTranslate(), f = !0, L = !0) : p = b.minTranslate();
                                    ...
                                    if (0 !== b.velocity) d = b.rtl ? Math.abs((-p - b.translate) / b.velocity) : Math.abs((p - b.translate) / b.velocity);
                            ...
                            setTranslate: function() {
                                ...
                                for (var i = 0; i < b.slides.length; i++) {
                                    ...
                                    if (1 >= s && s > -1 && (n = 90 * i + 90 * s, b.rtl && (n = 90 * -i - 90 * s)), a.transform(p), b.params.cube.slideShadows) {
                                        var c = b.isHorizontal() ? a.find(".swiper-slide-shadow-left") : a.find(".swiper-slide-shadow-top"),
                            ...
                            setTranslate: function() {
                                for (var e = b.translate, n = b.isHorizontal() ? -e + b.width / 2 : -e + b.height / 2, i = b.isHorizontal() ? b.params.coverflow.rotate : -b.params.coverflow.rotate, a = b.params.coverflow.depth, r = 0, o = b.slides.length; o > r; r++) {
                                    var s = b.slides.eq(r),
                                        ...
                                        u = (n - d - l / 2) / l * b.params.coverflow.modifier,
                                        p = b.isHorizontal() ? i * u : 0,
                                        c = b.isHorizontal() ? 0 : i * u,
                                        f = -a * Math.abs(u),
                    ...
                    off: function(e, t, n, i) {
                        for (var a = e.split(" "), r = 0; r < a.length; r++)
                            for (var o = 0; o < this.length; o++)
                                if ("function" == typeof t || t === !1) "function" == typeof t && (n = arguments[1], i = arguments[2] || !1), this[o].removeEventListener(a[r], n, i);
...
function(e) {
    ...
    function t(e) {
        ...
        var t = Number($delivery),
            n = document.getElementById("cost_value").innerHTML;
    ...
    var r = 0,
        ...
        p = 0,
        c = 0,
        f = document.querySelectorAll(".add-item");
    $delivery = $("input[name=delivery]:checked").val();
    ...
    for (var m = 0; m < f.length; m++) f[m].addEventListener("click", function(t) {
        ...
        $(this).position();
        d = (window.innerWidth - 982) / 2 + 160 * (n - 1),
            function() {
                i(d, u, p, c)
            }(setTimeout(function() {
                e(n, r, o, curImage)
